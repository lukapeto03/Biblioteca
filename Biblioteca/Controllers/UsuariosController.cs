...
namespace Biblioteca.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public ActionResult Index(String busqueda)
        {
            ...
            {
                usuarios = usuarios.Where(s => s.NombreCompleto.Contains(busqueda));
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "cod_usuario,Cedula,NombreCompleto,Direccion,Email,Telefono,TipoUsuario")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
